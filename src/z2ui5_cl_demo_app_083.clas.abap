CLASS z2ui5_cl_demo_app_083 DEFINITION PUBLIC.
  ...
  PUBLIC SECTION.
    ...
    DATA mt_01 TYPE STANDARD TABLE OF ty_s_tab_01 WITH DEFAULT KEY.
    ...
    DATA mt_02 TYPE STANDARD TABLE OF ty_s_tab_02 WITH DEFAULT KEY.
    DATA mt_02_display TYPE STANDARD TABLE OF ty_s_tab_02 WITH DEFAULT KEY.
    TYPES:
    ...
    DATA mt_tab_02_input TYPE STANDARD TABLE OF ty_s_tab_02_input WITH DEFAULT KEY.
